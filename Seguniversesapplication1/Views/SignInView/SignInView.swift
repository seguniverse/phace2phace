                ...
                ScrollView(.vertical, showsIndicators: false) {
                    VStack {
                        ...
                        Text(StringConstants.kLblSignIn2)
                            ...
                            .frame(width: getRelativeWidth(279.0), height: getRelativeHeight(95.0),
                                   alignment: .topLeading)
                            .padding(.top, getRelativeHeight(286.0))
                        VStack {
                            HStack(spacing: 0) {
                        ...
                        VStack {
                            HStack(spacing: 0) {
                                SecureField(StringConstants.kLblPassword,
                                    ...
                                    .font(FontScheme
                                        .kMontserratBlackItalic(size: getRelativeHeight(24.0)))
                                    .foregroundColor(ColorConstants.Gray900)
                                    .padding()
                            }
                            .frame(width: getRelativeWidth(596.0), height: getRelativeHeight(42.0),
                                   alignment: .center)
                            Divider()
                                .background(ColorConstants.Gray900)
                        }
                        ...
                        .frame(width: getRelativeWidth(599.0), height: getRelativeHeight(56.0),
                               alignment: .center)
