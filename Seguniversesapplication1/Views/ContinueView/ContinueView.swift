...
struct ContinueView: View {
    @StateObject var continueViewModel = ContinueViewModel()
        ...
        ZStack(alignment: .center) {
            ScrollView(.vertical, showsIndicators: false) {
                ZStack(alignment: .center) {
                    ...
                    .frame(width: getRelativeWidth(473.0), height: getRelativeHeight(500.0),
                           alignment: .topLeading)
                    .padding(.bottom, getRelativeHeight(252.0))
                    .padding(.trailing, getRelativeWidth(122.63))
                    ZStack {}
                        .hideNavigationBar()
                ...
                .hideNavigationBar()
                .frame(width: getRelativeWidth(596.0), height: getRelativeHeight(752.0),
                       alignment: .center)
