...
struct ArtboardTwentyThreeView: View {
    @StateObject var artboardTwentyThreeViewModel = ArtboardTwentyThreeViewModel()
    ...
    var body: some View {
        ZStack(alignment: .center) {
            ScrollView(.vertical, showsIndicators: false) {
                    ...
                    VStack(alignment: .leading, spacing: 0) {
                        Text(StringConstants.kMsgToContinueEnterYour)
                            ...
                            .frame(width: UIScreen.main.bounds.width,
                                   height: getRelativeHeight(346.0), alignment: .topLeading)
                        Divider()
                            .frame(width: UIScreen.main.bounds.width,
                ...
                .hideNavigationBar()
                .frame(width: UIScreen.main.bounds.width, height: getRelativeHeight(927.0),
                       alignment: .center)
...
struct ArtboardTwentyThreeView_Previews: PreviewProvider {
    static var previews: some View {
        ArtboardTwentyThreeView()
    }
}
