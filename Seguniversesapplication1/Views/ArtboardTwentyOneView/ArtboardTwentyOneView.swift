...
struct ArtboardTwentyOneView: View {
    @StateObject var artboardTwentyOneViewModel = ArtboardTwentyOneViewModel()
...
struct ArtboardTwentyOneView_Previews: PreviewProvider {
    static var previews: some View {
        ArtboardTwentyOneView()
    }
}
