                ...
                ScrollView(.vertical, showsIndicators: false) {
                    ZStack(alignment: .topLeading) {
                        Text(StringConstants.kMsgForgotPassword)
                            ...
                            .frame(width: getRelativeWidth(438.0), height: getRelativeHeight(174.0),
                                   alignment: .topLeading)
                            .padding(.bottom, getRelativeHeight(1153.81))
                            .padding(.trailing, getRelativeWidth(261.73))
                        ...
                        Divider()
                            ...
                            .padding(.leading, getRelativeWidth(100.62))
                            .padding(.trailing, getRelativeWidth(104.38))
                        ZStack {}
                            .hideNavigationBar()
                            ...
                            .padding(.leading, getRelativeWidth(99.2))
                            .padding(.trailing, getRelativeWidth(104.8))
